...
<html>
    ...
    <body>
        ...
        <div id="create-book" class="content scaffold-create" role="main">
            ...
            <g:form action="saveEverything">
                <fieldset class="form">
                    <h2>Book</h2>
                    <f:all bean="bookInstance" except="author,publisher"/>
                    <h2>Author</h2>
                    <f:all bean="authorInstance" except="books"/>
                    <h2>Publisher</h2>
                    <f:all bean="publisherInstance" except="books"/>
                </fieldset>
